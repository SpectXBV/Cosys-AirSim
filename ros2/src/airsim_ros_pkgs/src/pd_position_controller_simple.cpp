...
void PIDPositionController::initialize_ros()
{
    ...
    // ROS subscribers
    airsim_odom_sub_ = nh_->create_subscription<nav_msgs::msg::Odometry>("/airsim_node/" + vehicle_name + "/odom_local", 50, std::bind(&PIDPositionController::airsim_odom_cb, this, _1));
